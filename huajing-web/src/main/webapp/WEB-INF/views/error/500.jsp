...
<%@page import="com.huajing.common.web.Servlets"%>
<%@page import="com.huajing.common.utils.Exceptions"%>
<%@page import="com.huajing.common.utils.StringUtils"%>
...
<body>
	<div class="container-fluid">
		...
		<div class="errorMessage">
			...
			<a id="backUrlId" href="javascript:" onclick="history.go(-1);" class="btn">返回上一页</a> &nbsp;
